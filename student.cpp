...
using namespace std;
    ...
    Student::~Student() { 
        ...
        void Student::setID(string xID) { 
            studentID = xID; 
        }
        void Student::setFirst(string xFirst) { 
            firstName = xFirst; 
        }
        void Student::setLast(string xLast) { 
            lastName = xLast; 
        }
        void Student::setEmail(string xEmail) { 
            email = xEmail; 
        }
        ...
        void Student::setDegree(DegreeProgram xDegree) { /*DegreeProgram*/ 
            degreeprogram = xDegree; 
        }
